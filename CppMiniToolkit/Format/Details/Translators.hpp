...
namespace CppMiniToolkit
{
    ...
    {        
        ...
        public:
            ...
            {
                CPPMINITOOLKIT_UNREFERENCED_PARAMETER(unusedParam);
...
#define CPPMINITOOLKIT_CONVERT_TRANSLATOR( Type, BaseType, MaxValue ) \
    template < typename TCharType > \
    ...
    public: \
        ...
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(int32_t, int64_t, INT_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(uint32_t, uint64_t, UINT_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(char, int64_t, CHAR_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(unsigned char, uint64_t, UCHAR_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(short, int64_t, SHRT_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(unsigned short, uint64_t, USHRT_MAX);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(float, double, 0);
        CPPMINITOOLKIT_CONVERT_TRANSLATOR(unsigned long, uint64_t, ULONG_MAX);

#undef CPPMINITOOLKIT_CONVERT_TRANSLATOR
